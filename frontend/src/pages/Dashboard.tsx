...
const mockProjects = [
  ...
  {
    id: "3",
    title: "Cloud Engineer Application",
    status: "completed",
    date: "2026-07-19",
    score: 87
  }
      ...
      <aside className="hidden w-64 bg-white shadow-md lg:block">
        <div className="flex h-full flex-col">
          ...
          <div className="border-t px-3 py-4">
            ...
            <Link
              to="/settings"
              className="mt-2 flex items-center rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100"
            >
        ...
        <div className="p-6">
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-xs text-gray-500">↑ 4% from last month</p>
            </div>
            <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-xs text-gray-500">5 used this month</p>
            </div>
            <div className="rounded-lg bg-white p-6 shadow-sm">
              <p className="text-sm font-medium text-gray-500">Job Matches</p>
              <p className="mt-2 text-3xl font-bold text-orange-600">143</p>
              <p className="mt-1 text-xs text-gray-500">12 new this week</p>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Link
              to="/upload"
              className="rounded-lg border border-dashed border-gray-300 p-6 text-center transition hover:border-blue-500 hover:bg-blue-50"
            >
